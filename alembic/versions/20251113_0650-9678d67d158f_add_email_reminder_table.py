"""add_email_reminder_table

Revision ID: 9678d67d158f
Revises: add_checkin_files
Create Date: 2025-11-13 06:50:51.972041
...
revision: str = '9678d67d158f'
down_revision: Union[str, None] = 'add_checkin_files'
...
def upgrade() -> None:
    ...
    sa.Column('last_work_order_date', sa.Date(), nullable=True),
